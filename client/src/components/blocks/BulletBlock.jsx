function BulletBlock({ block }) {
  ...
  return (
    <article data-export-text="true" className="group rounded-2xl border border-purple-100 bg-purple-50/60 p-5 shadow-soft transition duration-200 hover:shadow-md">
