...
function ExampleBlock({ block }) {
  return (
    <article data-export-text="true" className="group rounded-2xl border border-slate-200 bg-slate-100/70 p-5 shadow-soft transition duration-200 hover:shadow-md">
