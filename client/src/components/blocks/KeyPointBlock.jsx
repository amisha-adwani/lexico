...
function KeyPointBlock({ block }) {
  return (
    <article data-export-text="true" className="group rounded-2xl border border-indigo-100 bg-gradient-to-br from-indigo-50 to-sky-50 p-6 shadow-soft transition duration-200 hover:-translate-y-0.5 hover:shadow-md">
